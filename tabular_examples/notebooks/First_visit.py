...
class MC_Agent():
    def __init__(self, env, gamma=0.9, epsilon=0.1, q_tolerance=0.001): # Alternativ: Hier nur Info über ENV übergeben, nicht ganzes ENV
        self.env = env
    ...
    def plot_action_value(self, episode): 
        ...
        tripcolor = ax.tripcolor(xy_coordinates[:,0], xy_coordinates[:,1], triangles, 
                                 facecolors=colours, **{"cmap": "coolwarm"}, vmin=-80, vmax=0.0)
        ax.margins(0)
        ax.set_aspect("equal")
